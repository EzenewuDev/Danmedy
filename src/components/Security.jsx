                    ...
                    <div className="relative">
                        ...
                        <div className="relative glass-card rounded-3xl p-8">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-4 bg-white/60 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-transparent">
                                    <div className="flex items-center space-x-3">
                                        <svg className="w-5 h-5 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                                        </svg>
                                        <span className="text-slate-700 dark:text-slate-300">Data Encryption</span>
                                    </div>
                                ...
                                <div className="flex items-center justify-between p-4 bg-white/60 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-transparent">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <span className="text-slate-700 dark:text-slate-300">Firewall Protection</span>
                                    </div>
                                    <span className="text-green-400 text-sm font-mono">Active</span>
                                </div>
                                ...
                                <div className="flex items-center justify-between p-4 bg-white/60 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-transparent">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <span className="text-slate-700 dark:text-slate-300">Access Control</span>
                                    </div>
                                    <span className="text-green-400 text-sm font-mono">Active</span>
                                </div>
                                ...
                                <div className="flex items-center justify-between p-4 bg-white/60 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-transparent">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <span className="text-slate-700 dark:text-slate-300">Backup Systems</span>
                                    </div>
